...
namespace Brumba.WaiterStupid.Tests
{
    ...
    public class OdometryCalculatorTests
    {
		...
		public void SetUp()
		{
		    _odometryCalc = new OdometryCalculator(new OdometryConstants
	    ...
	    {
	        var prevOdometry = new OdometryState {LeftTicks = 5, RightTicks = 10, Pose = new Vector3(10, 0, 0)};

	        var nextOdometry = _odometryCalc.UpdateOdometry(prevOdometry, 15, 20);
